    ...
    return (
        <div>
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                {/* <!-- Topbar Navbar --> */}
                {/* Cart visible if role admin */}
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown no-arrow mx-1">
                    <a class="nav-link dropdown-toggle" id='cart'  onClick={gotoCart}>
                    ...
                    {/* <!-- Nav Item - Messages --> */}
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle"  onClick={gotoHomePage}>
                            <i class="fas fa fa-home fa-fw"></i>
                            {/* <!-- Counter - Messages --> */}
                        </a>
                        {/* <!-- Dropdown - Messages --> */}
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
